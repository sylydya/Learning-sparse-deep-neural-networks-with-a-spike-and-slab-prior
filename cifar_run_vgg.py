...
parser = argparse.ArgumentParser(description='Cifar VGG Compression')

# Basic Setting
parser.add_argument('--seed', default=1, type = int, help = 'set seed')
parser.add_argument('--base_path', default='./result/cifar/vgg/', type = str, help = 'base path for saving result')
...
# Proposal Setting
parser.add_argument('--Proposal_B', default = [2000, 1000], type = int, nargs= 2, help='proposal_b value at epoch 150 and 225')
